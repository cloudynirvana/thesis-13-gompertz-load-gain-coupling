...
<head>
<meta charset="utf-8"/>
<title>Thesis #13. Gompertz-like hazard from load times gain</title>
<style>
@page {{
  size: A4;
  margin: 22mm 20mm 24mm 20mm;
  @bottom-center {{
    content: "Ogbonna KE. Thesis #13. Computational research only. Not a medical device.  " counter(page);
    font-size: 8.5pt;
    color: #444;
